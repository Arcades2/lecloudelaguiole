  ...
  register_post_type('slider',
    array(
      'labels'          => array(
        ...
        'add_new_item'  => __('Ajouter un nouveau slide'),
        'edit_item'     => __('Modifier un slide'),
        'search_items'  => __('Rechercher un slide'),
        'all_items'     => __('Tous les slides'),
        'view_items'    => __('Voir les slides'),
        'view_item'     => __('Voir la slide'),
      ),
      'public'          => true,
      'has_archive'     => true,
...
function create_post_figurines()
{
  register_post_type('figurine',
    array(
      'labels'          => array(
        'name'          => __('Figurines'),
        'singular_name' => __('Figurine'),
        'add_new_item'  => __('Ajouter une nouvelle figurine'),
        'edit_item'     => __('Modifier une figurine'),
        'search_items'  => __('Rechercher une figurine'),
        'all_items'     => __('Toutes les figurines'),
        'view_items'    => __('Voir les figurines'),
        'view_item'     => __('Voir la figurine'),
      ),
      'public'          => true,
      'has_archive'     => true,
      'rewrite'         => array('slug' => 'figurine'),
      'capability_type' => 'page',
      'menu_icon'       => 'dashicons-universal-access',
    )
  );
  register_taxonomy( 'figurines-category', 'figurine', array ('hierarchical' => true, 'label' => __('Catégorie figurines')));
}
add_action('init', 'create_post_figurines');
